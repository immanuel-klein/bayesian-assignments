...
# Calculate the probability that the next shipment contains defective products
p.next.defect.A <- defect.A
p.next.defect.B <- defect.B

# Probability that the next shipment contains defective products
p.next.defect <- posterior.A * p.next.defect.A + posterior.B * p.next.defect.B
